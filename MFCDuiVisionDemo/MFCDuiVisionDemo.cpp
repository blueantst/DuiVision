// MFCDuiVisionDemo.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CMFCDuiVisionDemoApp 对象

CMFCDuiVisionDemoApp theApp;


// CMFCDuiVisionDemoApp 初始化
...
BOOL CMFCDuiVisionDemoApp::InitInstance()
{
	...
	// 11162是应用程序ID,每个DUI应用程序应该使用不同的ID,ID主要用于进程间通信传递命令行时候区分应用
	DWORD dwLangID = 0;
