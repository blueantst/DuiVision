...
public:
	...
	DUI_DECLARE_ATTRIBUTES_BEGIN()
		...
		DUI_INT_ATTRIBUTE_DPI(_T("item-height"), m_nHeight, FALSE)
		DUI_INT_ATTRIBUTE(_T("frame-width"), m_nFrameWidth, FALSE)
		DUI_INT_ATTRIBUTE_DPI(_T("top-height"), m_nTopHeight, FALSE)
		DUI_INT_ATTRIBUTE_DPI(_T("bottom-height"), m_nBottomHeight, FALSE)
		DUI_INT_ATTRIBUTE(_T("left"), m_nLeft, FALSE)
		DUI_INT_ATTRIBUTE_DPI(_T("sep-height"), m_nSeparatorHeight, FALSE)
